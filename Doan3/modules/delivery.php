...
<body>
	...
	<div class="header-bottom">
	    <div class="wrap">
			...
			<li><a class="color4" href="#">ỐP LƯNG</a>
				<div class="megapanel">
					<div class="row">
						<div class="col1">
							<div class="h_nav">
								<h4>Thương hiệu</h4>
								<ul>
									<li><a href="modules/womens.php">APPLE</a></li>
									<li><a href="modules/womens.php">SAMSUNG</a></li>
									<li><a href="modules/womens.php">OPPO</a></li>
									<li><a href="modules/womens.php">VIVO</a></li>
                                    <li><a href="modules/womens.php">HTC</a></li>
								</ul>	
							</div>							
						</div>
						<div class="col1">
				...
				<div class="megapanel">
					<div class="col1">
							<div class="h_nav">
								...
								<ul>
									<li><a href="modules/mens.php">Tai nghe</a></li>
									<li><a href="modules/mens.php">Cục sạt</a></li>
									<li><a href="modules/mens.php">Pin dự phòng</a></li>
									<li><a href="modules/mens.php">Cường lực</a></li>
                                    <li><a href="modules/mens.php">Thẻ nhớ</a></li>
								</ul>	
							</div>							
						</div>
						<div class="col1">
		...
		<ul class="icon1 sub-icon1 profile_img">
			<li><a class="active-icon c2" href="#"> </a>
				<ul class="sub-icon1 list">
					<li><h3>Không có sản phẩm </h3><a href=""></a></li>
				</ul>
			</li>
		</ul>
	    <ul class="last">
	      <li><a href="#">Giỏ hàng (0)</a></li></ul>
	  </div>
    </div>
     <div class="clear"></div>
     </div>
	 ...
	 <div class="login">
     <div class="wrap">
	    <ul class="breadcrumb breadcrumb__t"><a class="home" href="../index.php">Trang chủ </a>  / Giao hàng và hoàn trả</ul>
		<h5 class="m_6">Giao hàng và hoàn trả</h5>	
		<p><strong>SHOP PT có chương trình đổi trả sản phẩm:</strong></p>
		<p><strong>-Điều kiện đổi trả:</strong></p>
		<p>Sản phẩm không giống mẫu, hay lỗi do vận chuyển</p>
		<p><strong>Lưu ý: Shop chỉ nhận đổi trả hàng trong vòng 3 ngày vì thế mong khách hàng xem hàng kĩ càng trước khi nhận hàng</strong></p>
		<p class="m_text">&nbsp;</p>
		<h5 class="m_6">&nbsp;</h5>
	</div>	
   </div>  
