    ...
    <body>
            ...
            <div class="wrap">
                <div class="cssmenu">
                    <ul>
                        ...
                        <li><a href="modules/login.php"><?php if (isset($_SESSION['TaiKhoankhachhang'])) echo $_SESSION['TaiKhoankhachhang'];
                        ...
                        <ul class="icon1 sub-icon1 profile_img">
                            <li><a class="active-icon c2" href="modules/checkout.php"> </a>
                                <ul class="sub-icon1 list">
                                    ...
                                    <li>
                                        <h3><?php echo number_format($tongtien, 0) . " VNĐ" ?></h3><a href=""></a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                        <ul class="last">
                            <li><a href="modules/checkout.php">Giỏ hàng (<?php if (isset($_SESSION['giohang'])) echo count($_SESSION['giohang']);
																			else echo "0" ?>)</a></li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="container-fluid padding">
            <div class="row welcome text-center">
                <div class="col-12">
                    <h1 class="display-4 "
                        style="background-color: rgba(122, 204, 236, 0.9);padding: 5px; border-radius: 5px;margin-bottom: -15px; ">
                        Các công ty hợp tác cùng chúng tôi</h1>
                </div>
                <hr>
                <div class="col-12">
                    <p></p>
        ...
        <div class="container-fluid padding">
            <div class="row padding">
                <div class="col-md-12 col-lg-6">
                    ...
                    <p>Thành lập năm 2001, Công ty TNHH Việt – Úc nhanh chóng trở thành một trong những công ty cung cấp
                        tôm giống và tôm bố mẹ uy tín, chất lượng nhất nước.</p>
                    <p>Công ty Việt – Úc nhập tôm bố mẹ từ Mỹ và Úc đạt tiêu chuẩn quốc tế quy trình sản xuất tôm giống
                        áp dụng tiêu chuẩn GlobalGAP. Năm 2012, Công ty Việt – Úc đưa ra thị trường 4 tỷ con giống, vượt
                        kế hoạch 0,5 tỷ con.</p>
                    <p>Trong đó bán cho các vùng nuôi 3,6 tỷ con, doanh thu 280 tỷ đồng; hỗ trợ vùng nuôi thiệt hại do
                        dịch bệnh 0,4 tỷ con, trị giá trên 3,2 tỷ đồng. Năm 2013, Việt – Úc sẽ tăng sản lượng giống lên
                        6,4 tỷ con (bằng 160% so năm 2012), giá bán
                        bình quân 80 đồng/con. Để hoàn thành kế hoạch, năm 2012 Công ty đã đầu tư thêm 40 tỷ đồng, lấp
                        bớt ao nuôi tôm thịt để lập thêm 31 trại sản xuất giống, cùng các hạ tầng kỹ thuật khác.</p>
                    <br>
                </div>
                <div class="col-lg-6">
        ...
        <div class="main">
            <div class="wrap">
                <div class="section group">
                    <div class="cont span_2_of_3" style="width: 106%;">
                                    ...
                                    <div class="inner_content clearfix">
                                        ...
                                        <div class="price">
                                            <div class="cart-left">
                                                ...
                                                <div class="price1">
                                                    <span
                                                        class="actual"><?php echo number_format($row['giasanpham'], 0) . ' VNĐ' ?></span>
                                                </div>
                                            </div>
		...
		<div class="footer-bottom">
            ...
            <div class="row padding">
                <div class="col-md-12 col-lg-6">
                    <h2>Tầm nhìn</h2>
                    <p>Tầm nhìn: Cung cấp đầy đủ truy nguyên nguồn gốc, tính bền vững và nâng cao hiệu suất cho
                        ngành công nghiệp nuôi tôm sú toàn cầu.</p>
                    <p>Sứ mệnh: Là nhà sản xuất và cung cấp giống lai chọn lọc hàng đầu đã được thuần hoá và thông
                        qua, cải tiến về mặt di truyền và được chứng nhận SPF giống tôm bố mẹ.</p>
                    <p class="left ">Sứ mệnh thương mại: Cung cấp cho ngành công nghiệp thủy sản Tôm Sú những giải
                        pháp cần thiết cho các vấn đề hiện tại của: – Truy nguồn gốc xuất xứ,cung cấp nguyên liêu
                        thô liên tục và bền vững (Hậu ấu trùng Bố Mẹ PPL/ Bố Mẹ giống) – Chứng
                        nhận giống Sạch Mầm Bệnh – Những đặc điểm được cải thiện (tăng trưởng, …) – Chứng nhận xuất
                        xứ (Giống gia hóa)</p>
                    <br>
        ...
        <div class="container-fluid padding">
            <div class="row text-center padding">
                ...
                <div class="col-12 social padding mt-1">
                    ...
                    <a href="https://www.w3schools.com/bootstrap/bootstrap_carousel.asp"><i
                            class="fab fa-twitter"></i></a>
                    <a href="https://mail.google.com/mail/u/0/#inbox"><i class="fab fa-google-plus-g"></i></a>
                    <a href="https://getbootstrap.com/docs/4.3/components/carousel/"><i
